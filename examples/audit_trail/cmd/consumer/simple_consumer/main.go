...
func main() {
	...
	offset := int64(0)    // we have to manually set and track the offset
	partition := int32(0) // we have to manually set and track the partition
	...
	consumer.StartSimpleConsumer(context.Background(), brokers, map[string]consumer.SimpleConsumer{
